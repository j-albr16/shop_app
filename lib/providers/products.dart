...
//    }
  ...
  Future<void> fetchAndSetProducts() async {
    const url = 'https://shop-app-79b44.firebaseio.com/products.json';
    try {
...
//JSON = JavaScript Object Notation
  ...
  Future<void> replaceProduct(Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url =
          'https://shop-app-79b44.firebaseio.com/products/${newProduct.id}.json';
  ...
  Future<void> deleteProduct(String id) async {
    final url = 'https://shop-app-79b44.firebaseio.com/products/$id.json';
